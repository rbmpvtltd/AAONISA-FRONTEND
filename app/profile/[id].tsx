...
//     const { profilePicture, username, likes, views } = useProfileStore();

//     // You can add dynamic posts/followers/following if available in store later
//     const postsCount = 120;
//     const followers = 5600;
//     const following = 180;

//     return (
//         <View style={styles.header}>
//             <Image
//                 source={profilePicture ? { uri: profilePicture } : theme.userImage}
