  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      <FlatList
        ...
        renderItem={({ item }) => (
          <TouchableOpacity
            style={[styles.categoryBar, { backgroundColor: colors.buttonBg }]}
            onPress={() => onSelect(item)}
            activeOpacity={0.8}
          >
            {editingId === item.id ? (
              <View style={styles.editRow}>
                ...
                />
                <TouchableOpacity
                  style={[styles.saveBtn, { backgroundColor: '#28a745' }]}
              ...
              <View style={styles.row}>
                <View style={styles.textSection}>
                  <Text style={[styles.name, { color: colors.buttonText }]}>{item.name}</Text>
                  <Text style={[styles.subText, { color: colors.subtitle }]}>
                    {item.reels.length} reels saved
                  </Text>
                </View>
                <View style={styles.actions}>
                  <TouchableOpacity
                    style={[styles.actionBtn, { backgroundColor: colors.link }]}
                    onPress={() => handleRename(item)}
                  >
                    <Text style={styles.btnText}>Rename</Text>
                  </TouchableOpacity>
